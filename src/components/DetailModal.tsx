...
export default function DetailModal() {
  ...
  const handleReady = useCallback((player: Player) => {
    ...
    // ✅ Fix: fallback to false if undefined
        ...
        <Box sx={{ top: 0, left: 0, right: 0, position: "relative", mb: 3 }}>
          <Box sx={{ width: "100%", position: "relative", height: "calc(9 / 16 * 100%)" }}>
            ...
            <Box sx={{
              ...
              top: 0, left: 0, bottom: 0, right: "26.09%", opacity: 1, position: "absolute",
                ...
                <Grid container spacing={5} alignItems="center">
                  <Grid item xs={12} sm={6} md={8}>
                    <Stack direction="row" spacing={1} alignItems="center">
                      <Typography variant="subtitle1" sx={{ color: "success.main" }}>{`${getRandomNumber(100)}% Match`}</Typography>
